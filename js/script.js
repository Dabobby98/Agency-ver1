// Language-aware component loading is now handled by language.js
// Components will be loaded by loadLanguageComponents() function
function initScriptFeatures() {
  if (typeof $ !== 'undefined') {
    // Listen for componentsLoaded event to initialize features
    ...
    setTimeout(initScriptFeatures, 100);
  }
}

// Start the initialization
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initScriptFeatures);
} else {
  initScriptFeatures();
}
...
function initThemeSwitch() {
    ...
    const updateLogos = () => {
        ...
        if (lightMode) {
            ...
            siteLogos.attr('src', 'image/nexon-logo.png');
...
$(document).ready(function(){
    const data = [
        ...
        {
            title: "Single Post",
            description: "Growth Strategies for Digital Businesses Home / Single Post Recent Blog April 14, 2025 Mastering Instagram and Facebook Ads April 14, 2025 Growth Strategies for Digital Business Transform Your Business with Nexon! Take your digital marketing to the next level with data-driven strategies and innovative solutions. Let's create something amazing together! Read More How to […]",
            url: "single_post.html"
        },
        {
            title: "Contact Us",
            description: "Contact Us Home / Contact Us Reach out to us Get in Touch Reach out to us for tailored digital solutions that drive results sollicitudin nec. Phone Number +1 (62) 987 7543 Email Address hello@markoagency.com Office Address Nexon HQ - 902 Digital Lane, San Francisco, CA 94110, USA",
            url: "contact.html"
        },
    ];
